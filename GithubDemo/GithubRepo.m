...
static NSString *const kReposUrl =
    @"https://api.github.com/search/repositories";
static NSString *const kClientId = @"c200b81321d357dd696d";
static NSString *const kClientSecret =
    @"9a213423db8ddd834ab61b5fd722ee5ca35aa3b5";
...
+ (void)fetchRepos:(GithubRepoSearchSettings *)settings
   successCallback:(void (^)(NSArray *))successCallback {
  ...
  [query appendString:[NSString
                          stringWithFormat:@" stars:>%ld", settings.minStars]];
